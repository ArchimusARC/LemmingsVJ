...
void SceneCredits::init()
{
	...
	colorTexture.loadFromFile("images/menu/credits.png", TEXTURE_PIXEL_FORMAT_RGBA);
...
void SceneCredits::mouseMoved(int mouseX, int mouseY, bool bLeftButton, bool bRightButton)
{
