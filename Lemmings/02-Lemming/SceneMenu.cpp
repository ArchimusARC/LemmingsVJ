...
void SceneMenu::init()
{
	...
	glm::vec2 texCoords[2] = {glm::vec2(0.f / 512.0, 0.f), glm::vec2(320.f / 512.0f, 160.f / 256.0f)};
...
void SceneMenu::eraseMask(int mouseX, int mouseY)
{
	int posX, posY;
...
void SceneMenu::applyMask(int mouseX, int mouseY)
{
	int posX, posY;
